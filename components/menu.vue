                ...
                <li class="menu-item">
                    ...
                    <div class="submenu">
                        <ul class="submenu-wrapper">
                            <li class="submenu-item"><NuxtLink to="/sites" class="menu__link ">Сайты</NuxtLink></li>
                            <li class="submenu-item"><NuxtLink to="/modules" class="menu__link ">Модули</NuxtLink></li>
                            <li class="submenu-item"><NuxtLink to="/uslugi/support" class="menu__link ">Поддержка</NuxtLink></li>
                            <li class="submenu-item"><NuxtLink to="/uslugi/seo-prodvizhenie-sajtov" class="menu__link ">Продвижение</NuxtLink></li>
                        </ul>
                    </div>
